...
public class LightSuffixTree implements Runnable {
    ...
    int setSide(List<Node> tree, List<String> suffixes, String suffix, Node root, String text, int half) {
    ...
    public static void main(String[] args) {
        new Thread(new LightSuffixTree()).start();
    }
}
